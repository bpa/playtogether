...
my $classic = Gamed::Game::SpeedRisk::Board->new( variant => 'Classic' );
...
subtest 'moving' => sub {
    ...
    $p1->game( { cmd => 'move', from => 0, to => 0, armies => 1 },
...
subtest 'produce armies for countries' => sub {
    ...
    $risk->{state_table}{PLAYING}->generate_armies($risk);
