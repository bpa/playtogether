...
my ( $game, $n, $e ) = game(
    ...
    [qw/n e/],
    {
        ...
        bidder => 1,
        bid    => 135,
        nest   => [qw/1R 14R 13R 12R 11R/],
        seat   => [ {}, { cards => [qw/5G 6G 7G 8G 9G 5R 6R 7R 8R 9R/] } ],
        state_table => { start => Gamed::Game::Rook::Declaring->new('end'), } } );
like( ref( $game->{state} ), qr/Declaring/, 'Ready to start test' );

$e->got_one( { nest => [qw/1R 14R 13R 12R 11R/] }, 'Nest sent to bid winner' );
hand_is($game->{seat}[1]{cards}, [qw/1R 14R 13R 12R 11R 5G 6G 7G 8G 9G 5R 6R 7R 8R 9R/], 'Nest added to player hand');
...
hand_is( $game->{nest}, [qw/5G 6G 7G 8G 9G/], 'Nest saved in game' );
hand_is( $game->{seat}[1]{cards}, [qw/5R 6R 7R 8R 9R 11R 12R 13R 14R 1R/], 'Player hand set in game' );
