var RoboRally = function (socket) {
  var stage, renderer, players, public, id, private, now, cards, board, modal, ready_button, through;
    ...
    for (var i=0; i<data.actions.length; i++) {
      ...
      for (var j=0; j<action.length; j++) {
        ...
        if (a.move !== undefined) {
          ...
          tween.push(move(sprite, x, y, 1000 * a.move, delay - 1000 * d));
          console.log('move', a.piece, x, y, 1000 * a.move, delay - 1000 * d);
          if (a.die === 'fall') tween.push(fall(sprite, 1000, delay - a.move));
        }
        if (a.rotate !== undefined) {
          if (a.move === undefined) {
            tween.push(rotate(sprite, a.rotate, 1000, delay - 1000));
          }
          else {
            tween.push(rotate(sprite, a.rotate, 500, delay - 500));
          }
        }
      }
    }
